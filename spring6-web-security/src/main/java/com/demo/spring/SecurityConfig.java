...
*/
	@Autowired
	public void configureDbStore(AuthenticationManagerBuilder auth) throws Exception{
		auth.jdbcAuthentication()
			.dataSource(dataSource)
			//queries are optional if using default schema
